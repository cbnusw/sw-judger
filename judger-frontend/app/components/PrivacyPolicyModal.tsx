      ...
      <Modal.Body className="max-h-[27.5rem]">
        <div className="space-y-6">
          <p className="text-xs leading-relaxed text-gray-500 ">
            Judge (https://swjudge.cbnu.ac.kr/이하 SW중심대학사업단) 은
          ...
          <p className="text-xs leading-relaxed text-gray-500 ">
            ...
            하실 수 있으며 Judge은(는) 이에 대해 지체 없이 조치하겠습니다. ③
            제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등
            대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙
            별지 제11호 서식에 따른 위임장을 제출하셔야 합니다. ④ 개인정보 열람
            및 처리정지 요구는 개인정보보호법 제35조 제5항, 제37조 제2항에
            의하여 정보주체의 권리가 제한 될 수 있습니다. ⑤ 개인정보의 정정 및
            삭제 요구는 다른 법령에서 그 개인정보가 수집 대상으로 명시되어 있는
            경우에는 그 삭제를 요구할 수 없습니다. ⑥ SW중심대학사업단은 정보주체
            권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람
          ...
          <p className="text-xs leading-relaxed text-gray-500 ">
            ...
            Judge은(는) 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
            ...
            설치•운영 및 거부 : 웹브라우저 상단의 도구 (인터넷 옵션)개인정보
            메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다. 다. 쿠키
