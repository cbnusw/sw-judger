...
export default function Footer() {
  ...
  return (
    <div className="w-full flex justify-start mt-auto font-light text-[10px] pt-5 pb-10 px-5 leading-[1.175rem] bg-[#191f28]">
      <div className="flex flex-col w-[25rem] 2md:w-[40rem] 2lg:w-[47.5rem] mx-auto py-10">
        <div className="flex justify-between w-full">
          <div className="flex flex-wrap gap-x-20 gap-y-8">
            <div className="flex flex-col text-[0.8rem] leading-[1.25]">
              <span className="text-[#b0b8c1] font-bold">서비스</span>
              <Link
                href="/contests"
                className="mt-2 text-[#6b7684] font-medium hover:underline py-[0.375rem]"
              >
                대회
              </Link>
              <Link
                href="/exams"
                className="text-[#6b7684] font-medium hover:underline py-[0.375rem]"
              >
                시험
              </Link>
              <Link
            ...
            <div className="flex flex-col text-[0.8rem] leading-[1.25]">
              <span className="text-[#b0b8c1] font-bold">관련 사이트</span>
              <a
                target="_blank"
            ...
            <div className="flex flex-col text-[0.8rem] leading-[1.25]">
              <span className="text-[#b0b8c1] font-bold">고객센터</span>
              <span className="mt-2 text-[#6b7684] font-medium py-[0.375rem]">
        ...
        <div className="mt-10 text-xs grid grid-cols-1 gap-y-5">
          <span className="text-[0.75rem] leading-[1.25] text-[#b0b8c1] font-bold">
            Copyright © 충북대학교 SW중심대학사업단. All Rights Reserved
          </span>
          <p className="flex flex-col gap-y-[0.1rem] tracking-tight text-[0.65rem]">
          ...
          <p className="flex gap-5 text-[0.65rem]">
            <button
              onClick={() => setOpenPrivacyPolicyModal('default')}
              className="text-[#b0b8c1] hover:underline font-medium"
            >
              개인정보 처리방침
            </button>
