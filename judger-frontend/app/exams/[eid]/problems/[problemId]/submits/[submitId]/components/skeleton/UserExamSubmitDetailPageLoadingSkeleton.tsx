import UserExamSubmitDetailCodeLoadingSkeleton from './UserExamSubmitDetailCodeLoadingSkeleton';

export default function UserExamSubmitDetailPageLoadingSkeleton() {
  return (
    <div className="mt-6 mb-24 px-5 2lg:px-0 overflow-x-auto">
      <div className="flex flex-col w-[60rem] mx-auto">
        ...
        <div className="border-y border-[#e4e4e4] border-t-2 border-t-gray-400">
          <UserExamSubmitDetailCodeLoadingSkeleton />
        </div>
