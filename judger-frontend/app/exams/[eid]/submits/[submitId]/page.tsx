...
import UsersExamSubmitDetailPageLoadingSkeleton from './components/UsersExamSubmitDetailPageLoadingSkeleton';
...
export default function UsersExamSubmitDetail(props: DefaultProps) {
  ...
  if (isLoading || isPending)
    return <UsersExamSubmitDetailPageLoadingSkeleton />;
            ...
            <table className="w-full text-sm text-left text-gray-500 ">
              ...
              <tbody>
                <tr className="h-[2.5rem] border-b-[1.25px] border-[#d1d6db] text-xs text-center">
                  ...
                  <td className="text-[#4e5968]">{submitInfo.user.name}</td>
                  <td
                    className={`${
