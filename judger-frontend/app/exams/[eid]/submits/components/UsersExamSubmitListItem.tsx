...
export default function UsersExamSubmitListItem({
  ...
  return (
    ...
    >
      ...
      <td className="text-[#4e5968]">{examSubmitInfo.user.no}</td>
      <td className="text-[#4e5968]">{examSubmitInfo.user.name}</td>
      ...
      <td className="text-[#4e5968]">{examSubmitInfo.language}</td>
