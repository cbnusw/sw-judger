...
const operatorRoles = ["admin", "operator"];

const roles = [...operatorRoles, ...notOperatorRoles];

const permissions = ["Contest", "Assignment", "Problem", "all", "qna"];

const fileTypes = ["Contest", "Assignment", "Problem", "Submit"];
